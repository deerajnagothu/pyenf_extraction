...
#video_folder = "/home/deeraj/Documents/Projects/pyENF_extraction_rolling_shutter/Recordings/Deepfake/set4/original/"
#video_rec_name = "21__exit_phone_room.mp4"

video_folder = "/home/deeraj/Documents/Projects/pyENF_extraction_rolling_shutter/Recordings/Deepfake/set4/deepfake/"
video_rec_name = "21_09__exit_phone_room__JEELOMN2.mp4"
...
def second_half_extract_row_pixel(frame):
    ...
    if frame_shape[2] == 3:  # its an RGB frame
        average_frame_across_rgb = np.mean(frame, axis=2)
        average_frame_across_column = np.mean(average_frame_across_rgb[:,:480], axis=1)
    else:
...
print("Width of frame :",width_of_frame)
print("Height of frame :",height_of_frame)
