...
power_rec_name_2 = "deepfakevoice_10min.wav"
...
power_signal0_orig, fs = librosa.load(power_signal_filename, sr=fs)  # loading the power ENF data
...
variable_location = folder + "duplicate_rho.pkl"
